...
function Hero() {
  const stats = [
    [UsersRound, '500+', 'Events delivered', 'Successfully executed across various scales and industries.'], 
    [MapPin, '30+', 'Cities covered', 'Bringing our expertise to venues across the nation.'], 
    [ShieldCheck, '100%', 'Client commitment', 'Dedicated to delivering flawless experiences every time.'], 
    [Trophy, '10+', 'Years of experience', 'A decade of industry leadership and creative excellence.']
  ];
